...
| JavaScript                | [componentize-qjs](https://github.com/andreiltd/componentize-qjs)                                      | 0.2 + 0.3    | Tomasz Andrzejak  |                                                                                                                                                                                     |
| Kotlin                    | [Kotlin](https://kotlinlang.org/docs/wasm-wasi.html)                                                   | 0.2          | JetBrains         |                                                                                                                                                                                     |
...
| AI Agent Runtime   | [Capsule](https://github.com/mavdol/capsule)                                | 0.2          | Mohamed Diallo    |                                                                                                    |
| Bazel Extension    | [WebAssembly Component Rules](https://rules-wasm-component.pulseengine.eu/) | 0.2          | Pulse Engine      |                                                                                                    |
| Browser            | [Google Chrome](https://chrome.google.com)                                  | -            | Google            | [Wasm Component model under evaluation](https://issues.chromium.org/issues/474661098)              |
| Buck2 Extension    | [Wasmono](https://github.com/andreiltd/wasmono)                             | 0.2 + 0.3    | Tomasz Andrzejak  |                                                                                                    |
...
| Command Line       | [zwasm](https://github.com/clojurewasm/zwasm)                               | 0.2          | ClojureWasm       |                                                                                                    |
...
- [sample-wasi-http-kotlin](https://github.com/Kotlin/sample-wasi-http-kotlin/): A sample `wasi:http` server written in Kotlin.
